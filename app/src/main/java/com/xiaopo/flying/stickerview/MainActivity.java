...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stickerView.setOnStickerOperationListener(new StickerView.OnStickerOperationListener() {
            ...
            @Override
            public void onStickerMoved(@NonNull Sticker sticker) {
                Log.d(TAG, "onStickerMoved");
            }

            @Override
            public void onStickerTouchedAuxiliaryLines(@NonNull Sticker sticker) {
                Log.d(TAG, "onStickerTouchedAuxiliaryLines");
            }
        });
